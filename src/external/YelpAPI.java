...
public class YelpAPI {
    ...
    private static final String CLIENT_ID = "oRSpH9eVKZR7EzQCuMWSlw";
    private static final String CLIENT_SECRET = "ckUgxWCPQcMEYpWMyHPNGER5tplkX6qGiZNd6zdKdpmZO8icokC0B52d1DSWgvAv";
